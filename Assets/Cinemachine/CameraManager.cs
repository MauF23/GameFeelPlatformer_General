...
public class CameraManager : MonoBehaviour
{
    ...
    //Varibales para función de debug, probar el switch de cámaras.
    ...
    private void Update()
    {
        //Debug de la función CameraSwitch
    ...
    /// <summary>
    /// Asignar la prioridad de las cámaras usando su orden en la lista
    /// </summary>
    ...
    /// <summary>
    /// Cambia a la cámara cuya prioridad sea la especificada.
    /// </summary>
    /// <param name="cameraIndex">la prioridad/ínidice de la cámara deseada</param>
